...
public class MenuFase extends Cenario
{
    ...
    {    
        ...
        for(int i = 0; i < fases.length; i++){
            fases[i] = new Botao();
            fases[i].setImage(new GreenfootImage("fase" + i + "-min.png"));
        }
        
        //Adiciona as fases na tela
    ...
    public void act(){
        //Verifica em qual fase o jogador clicou
        ...
        if(Greenfoot.mouseClicked(fases[5])){
            Botao.somAoClicar.play();
            Greenfoot.setWorld(new Partida(Geral.criarVetorInimigo(5), Geral.backgroundFase05, 75, 5));
        }if(Greenfoot.mouseClicked(fases[6])){
            Botao.somAoClicar.play();
            Greenfoot.setWorld(new Partida(Geral.criarVetorInimigo(6), Geral.backgroundFase06, 80, 6));
        }if(Greenfoot.mouseClicked(fases[7])){
            Botao.somAoClicar.play();
            Greenfoot.setWorld(new Partida(Geral.criarVetorInimigo(7), Geral.backgroundFase07, 85, 7));
